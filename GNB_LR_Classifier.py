...
class NaiveBayesClassifier:
    ...
    def __naive_bayesian_probability(self, params):
        denominator = self._pos_pobability * np.prod(
            self.__gaussian_probability_func(self._pos_rows_mean, self._pos_rows_var, params)) \
                      + self._neg_pobability * np.prod(
            self.__gaussian_probability_func(self._neg_rows_mean, self._neg_rows_var, params))
        numerator = self._pos_pobability * np.prod(
            self.__gaussian_probability_func(self._pos_rows_mean, self._pos_rows_var, params))
